...
- use when a JPA entity's primary-key handling or persistence lifecycle affects
  equality semantics
- use `../correctness-equals-hashcode/SKILL.md` for the general equality
  contract checks
...
2. Apply `../correctness-equals-hashcode/SKILL.md` to verify the general
